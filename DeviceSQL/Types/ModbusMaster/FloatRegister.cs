    ...
    public partial class UserDefinedTypes
    {
        ...
        public struct FloatRegister : INullable, IBinarySerialize
        {
            ...
            public SqlSingle Value
            {
                get
                {
                    return new Device.Modbus.Data.FloatRegister(new Device.Modbus.Data.ModbusAddress(Convert.ToUInt16(Address.RelativeAddress), Address.IsZeroBased.Value), ByteSwap.Value, WordSwap.Value).Value;
                }
                set
                {
                    Data = new Device.Modbus.Data.FloatRegister(new Device.Modbus.Data.ModbusAddress(Convert.ToUInt16(Address.RelativeAddress), Address.IsZeroBased.Value), ByteSwap.Value, WordSwap.Value) { Value = Convert.ToUInt16(value) }.Data;
                }
            }
