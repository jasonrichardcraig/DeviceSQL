    ...
    public partial class UserDefinedTypes
    {
        ...
        public struct CoilRegister : INullable, IBinarySerialize
        {
            ...
            public SqlBoolean Value
            {
                get
                {
                    return new Device.Modbus.Data.CoilRegister(new Device.Modbus.Data.ModbusAddress(Convert.ToUInt16(Address.RelativeAddress), Address.IsZeroBased.Value)).Value;
                }
                set
                {
                    Data = new Device.Modbus.Data.CoilRegister(new Device.Modbus.Data.ModbusAddress(Convert.ToUInt16(Address.RelativeAddress), Address.IsZeroBased.Value)) { Value = value.Value }.Data;
                }
            }
