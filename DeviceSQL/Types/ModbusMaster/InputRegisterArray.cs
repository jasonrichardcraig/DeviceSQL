    ...
    public partial class UserDefinedTypes
    {
        ...
        public struct InputRegisterArray : INullable, IBinarySerialize
        {
            ...
            public SqlInt16 GetShort(SqlByte registerIndex, SqlBoolean byteSwap)
            {
                ...
                return new Device.Modbus.Data.ShortRegister(new Device.Modbus.Data.ModbusAddress(Convert.ToUInt16(address.RelativeAddress.Value), address.IsZeroBased.Value)) { ByteSwap = byteSwap.Value, Data = inputRegisters[Convert.ToByte(registerIndex.Value)].data }.Value;
            }
