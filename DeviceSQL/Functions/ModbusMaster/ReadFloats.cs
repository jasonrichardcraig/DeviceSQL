...
namespace DeviceSQL.Functions
{
    ...
    {
        [SqlFunction]
        public static Types.ModbusMaster.FloatRegisterArray ReadFloats(SqlString deviceName, Types.ModbusMaster.FloatRegisterArray floatRegisterArray)
        {
            ...
            return new Types.ModbusMaster.FloatRegisterArray() { floatRegisters = floatRegisters.Select(floatRegister => new Types.ModbusMaster.FloatRegister() { Address = new Types.ModbusMaster.ModbusAddress { RelativeAddress = floatRegister.Address.RelativeAddress, IsZeroBased = floatRegister.Address.IsZeroBased }, Data = floatRegister.Data }).ToList() };
        }
    }
}
