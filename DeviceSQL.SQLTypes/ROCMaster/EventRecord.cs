...
namespace DeviceSQL.SQLTypes.ROCMaster
{
    ...
    public struct ROCMaster_EventRecord : INullable, IBinarySerialize
    {
        ...
        public static ROCMaster_EventRecord Null
        {
            get
            {
                return new ROCMaster_EventRecord() { IsNull = true };
            }
        }
        ...
        public SqlDateTime DateTimeStamp
        {
            get
            {
                var dateTimeStamp = new EventRecord(Convert.ToUInt16(Index), Data).DateTimeStamp;
        ...
        public SqlByte FstNumber
        {
            get
            {
                var fstNumber = new EventRecord(Convert.ToUInt16(Index), Data).FstNumber;
        ...
        public SqlByte PointType
        {
            get
            {
                var pointType = new EventRecord(Convert.ToUInt16(Index), Data).PointType;
        ...
        public SqlByte LogicalNumber
        {
            get
            {
                var logicalNumber = new EventRecord(Convert.ToUInt16(Index), Data).LogicalNumber;
        ...
        public SqlByte ParameterNumber
        {
            get
            {
                var parameterNumber = new EventRecord(Convert.ToUInt16(Index), Data).ParameterNumber;
        ...
        public SqlInt32 Tag
        {
            get
            {
                var tag = new EventRecord(Convert.ToUInt16(Index), Data).Tag;
        ...
        public SqlDateTime PowerRemovedDateTime
        {
            get
            {
                var powerRemovedDateTime = new EventRecord(Convert.ToUInt16(Index), Data).PowerRemovedDateTime;
        ...
        public SqlString CalibrationPointType
        {
            get
            {
                var calibrationPointType = new EventRecord(Convert.ToUInt16(Index), Data).CalibrationPointType;
        ...
        public SqlString CalibrationMultivariableSensorInput
        {
            get
            {
                var calibrationMultivariableSensorInput = new EventRecord(Convert.ToUInt16(Index), Data).CalibrationMultivariableSensorInput;
        ...
        public SqlString CalibrationType
        {
            get
            {
                var calibrationType = new EventRecord(Convert.ToUInt16(Index), Data).CalibrationType;
        ...
        public SqlString EventCode
        {
            get
            {
                return new EventRecord(Convert.ToUInt16(Index), Data).EventCode.ToString();
            }
        }
        ...
        public SqlString OperatorId
        {
            get
            {
                return new EventRecord(Convert.ToUInt16(Index), Data).OperatorId;
            }
        }
        ...
        public SqlString EventText
        {
            get
            {
                return new EventRecord(Convert.ToUInt16(Index), Data).EventText;
            }
        }
        ...
        public SqlBinary OldValue
        {
            get
            {
                return new EventRecord(Convert.ToUInt16(Index), Data).OldValue;
            }
        }
        ...
        public SqlSingle FstFloatValue
        {
            get
            {
                var fstFloatValue = new EventRecord(Convert.ToUInt16(Index), Data).FstFloatValue;
        ...
        public SqlBinary NewValue
        {
            get
            {
                return new EventRecord(Convert.ToUInt16(Index), Data).NewValue;
            }
        }
        ...
        public static ROCMaster_EventRecord Parse(SqlString stringToParse)
        {
            ...
            {
                return new ROCMaster_EventRecord() { Index = ushort.Parse(parsedEventRecord[0]), Data = base64Bytes };
            }
            else
            {
